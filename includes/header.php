...
<header class="main-header">
    ...
    <div class="header-actions">
        ...
        <button class="mobile-search-btn" aria-label="Buscar" onclick="const c = document.getElementById('search-container-main'); const isActive = c.classList.toggle('active'); window.toggleScrollLock(isActive); if(isActive) { setTimeout(() => document.getElementById('buscador-principal').focus(), 100); }">
